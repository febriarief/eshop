                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <h3
                                                                                            style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:Oswald, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">
                                                                                            Terima Kasih Atas Pesanan
                                                                                            Anda
                                                                                        </h3>
                                                                                        <p
                                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#31394E;font-size:14px">
                                                                                            <br>
                                                                                        </p>
                                                                                        <p
                                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#31394E;font-size:14px">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" bgcolor="#31394E"
                                                                                        style="padding:0;Margin:0">
                                                                                        <span
                                                                                            class="msohide es-button-border"
                                                                                            style="border-style:solid;border-color:#2CB543;background:#31394E;border-width:0px;display:inline-block;border-radius:0px;width:auto;mso-hide:all"><a
                                                                                                href="{{ env('APP_URL') }}/order/view-order?order_id={{ $order->id }}"
                                                                                                class="es-button"
                                                                                                target="_blank"
                                                                                                style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:28px;display:inline-block;background:#31394E;border-radius:0px;font-family:Oswald, sans-serif;font-weight:normal;font-style:normal;line-height:34px;width:auto;text-align:center;padding:10px 20px 10px 20px;mso-padding-alt:0;mso-border-alt:10px solid #31394E">
                                ...
                                <tr>
                                    <td align="center" style="padding:0;Margin:0">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0"
                                            cellspacing="0"
                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;border-top:1px solid #cccccc;border-right:1px solid #cccccc;border-left:1px solid #cccccc;width:600px;border-bottom:1px solid #cccccc"
                                            role="none">
                                            <tbody>
                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        style="padding:0;Margin:0">
                                                                                        <h3
                                                                                            style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:Oswald, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">
                                                                                            <strong>RINCIAN
                                                                                                PESANAN</strong>
                                                                                        </h3>
                                                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="esdev-adapt-off" align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0"
                                                            class="esdev-mso-table" role="none"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:558px">
                                                            <tbody>
                                    ...
                                    <td align="center" style="padding:0;Margin:0">
                                        <table bgcolor="#ffffff" class="es-content-body" align="center"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        style="Margin:0;padding-left:20px;padding-right:20px;padding-bottom:40px">
